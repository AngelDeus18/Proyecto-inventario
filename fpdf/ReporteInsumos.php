...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE INSUMOS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(45, 10, utf8_decode('Fecha Registro'), 1, 1, 'C', 1);
   }
...
$consulta_reporte_insumos = $conn->query("SELECT * FROM insumos");
...
while ($datos_reporte = $consulta_reporte_insumos->fetch_object()) {
   ...
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->NomInsumo), 1, 0, 'C', 0);
   $pdf->Cell(80, 10, utf8_decode($datos_reporte->Descripcion), 1, 0, 'C', 0);
   $pdf->Cell(30, 10, utf8_decode($datos_reporte->Estado), 1, 0, 'C', 0);
   $pdf->Cell(45, 10, utf8_decode($datos_reporte->FechaRegistro), 1, 1, 'C', 0);
   $i++;
}
