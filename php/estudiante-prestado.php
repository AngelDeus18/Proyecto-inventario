...
<body>
    <nav>
        ...
        <ul class="list">
            <li><a href="estudiante-inicio.php">Inicio</a></li>
            <li><a href="estudiante-insumos.php">Insumos</a></li>
    ...
    <nav class="menu_abajo">
        ...
        <li><a href="estudiante-insumos.php">Insumos</a></li>
            <li><a href="estudiante-prestado.php"><i class="fa-solid fa-plus"></i> Prestado</a></li>
        </ul>
    </nav>
    <main class="welcome-container">
        <div class="welcome-text">
            <h1>Estimado estudiante <?php echo $nombreUsuario . " "; ?> usted por el momento tiene prestado: <?php echo $insumosPrestados; ?></h1>
