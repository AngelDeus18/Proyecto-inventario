...
(1, 'Administrador'), (2, 'Supervisor'), (3, 'Profesor'), (4, 'Estudiante');

INSERT INTO `usuarios` (`id`, `nombre`, `email`, `cedula`, `contraseña`, `id_roles`) VALUES
(1, 'Angel', 'jorge@gmail.com', 1023987654, 'angel123', 1), (2, 'Pablo', 'pablo@gmail.com', 1984736789, 'pablo123', 2), (3, 'Pedro', 'pedro@gmail.com', 1674567893, 'pedro123', 3), (4, 'Julian', 'julian@gmail.com', 1345637892, 'julian123', 4);
